...
export const RULE_TYPES: RuleMeta[] = [
  {
    value: "BOOKING_DATE_RANGE",
    label: "Booking Date Range",
    hint: "Coupon applies only between selected booking dates",
    valueKind: "dateRange",
    operators: ["BETWEEN"],
  },
  {
    value: "BOOKING_TIME_RANGE",
    label: "Booking Time Range",
    hint: "Coupon applies only between selected booking times",
    valueKind: "timeRange",
    operators: ["BETWEEN"],
  },
  {
    value: "BOOKING_DURATION_MIN",
    label: "Booking Duration",
    hint: "Restrict to selected booking durations",
    valueKind: "multi",
    operators: ["IN", "NOT_IN"],
  },
  {
